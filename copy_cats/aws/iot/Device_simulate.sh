...
do
    ...
    aws iot-data update-thing-shadow --thing-name sharoncubet --payload "{\"state\":{\"reported\":{\"stress\":100,\"heartRateVariability\":$j,\"heartRate\":$j,\"spo2\":30}},\"version\":$i}" "output.txt"
